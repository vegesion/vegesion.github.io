...
def draw():
    ...
    ellipseMode(CENTER)
    fill(255,0,0)
    ellipse(canvas_x_size-330-r, 53, r,r)
    fill(0,255,255)
    ellipse(canvas_x_size-330-r, 93, r,r)
    fill(0)
    text('ball1 v : {:.1f}'.format(sqrt(ball1.v.x**2 + ball1.v.y**2)), canvas_x_size-330, 60)
    text(', vx : {:.2f}, vy : {:.1f}'.format(ball1.v.x, -ball1.v.y), canvas_x_size-200, 60)
    text('ball2 v : {:.1f}'.format(sqrt(ball2.v.x**2 + ball2.v.y**2)), canvas_x_size-330, 100)
    text(', vx : {:.2f}, vy : {:.1f}'.format(ball2.v.x, -ball2.v.y), canvas_x_size-200, 100)
    text(passed_time, canvas_x_size-200, 20)
    text('passed_time', canvas_x_size-330, 20)
